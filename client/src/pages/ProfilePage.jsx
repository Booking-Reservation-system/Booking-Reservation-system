      ...
      <div className="flex flex-row gap-20">
        <div className="flex flex-col gap-10">
          ...
          <div> {/* Refactor to tailwind!!*/}
            ...
            <p className="text-xl text-center" style={{ display: 'flex', alignItems: 'left', justifyContent: 'left', marginBottom: '10px'}}>
              <GoCheck className="ml-2" size={30}/>
              <span style={{ marginLeft: '25px' }}>Email address: ...</span> {/* Display email address*/}
            </p>
            <p className="text-xl text-center" style={{ display: 'flex', alignItems: 'left', justifyContent: 'left', marginBottom: '10px'}}>
              <GoCheck className="ml-2" size={30}/>
              <span style={{ marginLeft: '25px' }}>Phone number: ...</span> {/* Dispay phone number*/}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-xl text-center" style={{ display: 'flex', alignItems: 'left', justifyContent: 'left', marginBottom: '10px'}}>
              <MdOutlineEmail  className="ml-2" size={30}/>
              <span style={{ marginLeft: '25px' }}>My email: something@gmail.com</span>
          </p>
          <p className="text-xl text-center" style={{ display: 'flex', alignItems: 'left', justifyContent: 'left', marginBottom: '10px'}}>
              <IoPhonePortraitOutline  className="ml-2" size={30}/>
              <span style={{ marginLeft: '25px' }}>My phone number: 0943422784</span>
          </p>
          <p className="text-xl text-center" style={{ display: 'flex', alignItems: 'left', justifyContent: 'left', marginBottom: '10px'}}>
