        ...
        <div className="grid grid-cols-3 gap-20">
          <div className="flex flex-col gap-10 col-span-1 relative">
            <div className="flex flex-col gap-8 sticky top-[100px]">
              ...
              <div className="flex flex-row w-[380px] h-[240px] items-start border-2 border-gray-400 rounded-[20px] gap-6 py-6 px-6">
                <div>
                  ...
                  {provider === "google" ? (
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex flex-row gap-8">
                        <button className="rounded-lg hover:opacity-80 hover:bg-rose-500 hover:text-white hover:border-none transition w-[100px] p-2 border-black border-2" onClick={editProfile.onUserOpen}>
                          Edit
                        </button>
                        <button className="rounded-lg hover:opacity-80 hover:bg-rose-500 hover:text-white hover:border-none transition w-[200px] p-2 border-black border-2" onClick={editProfile.onChangePasswordOpen}>Change password</button>
                      </div>
                    </div>
                  )}
                </div>
